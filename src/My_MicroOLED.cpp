...
void My_MicroOLED::drawProgressBar(uint16_t x, uint16_t y, uint16_t width, uint16_t height,
                                   uint8_t progress)
{
...
void My_MicroOLED::updateDisplay(const float& voltage, const float& temperature,
